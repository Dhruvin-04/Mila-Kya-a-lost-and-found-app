...
3. Create a `.env` file in the project root with Firebase and Cloudinary values:
```bash
...
4. In Cloudinary, create an **unsigned** upload preset (Settings → Upload) and use its name for `EXPO_PUBLIC_CLOUDINARY_UPLOAD_PRESET`.
